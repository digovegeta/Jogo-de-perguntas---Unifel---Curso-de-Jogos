...
public class JogoDePerguntas{
   ...
   public void play(){
    ...
    private void montarPerguntas(){
        ...
        perguntas.Add("2", new Pergunta("O C# é uma linguagem de qual categoria?", "Estruturada", "Orientada a Objetos", "Script", "Marcação"));
        ...
        perguntas.Add("5", new Pergunta("Dentre os tipos de variáveis abaixo, qual consome 1 bit?", " int", "char", "bool", "string"));
        ...
        perguntas.Add("9", new Pergunta("Qual dos nomes de variáveis abaixo é válido?", "123var", "nome variavel", "!nome!", "Variavel_123_Ex"));
        perguntas.Add("10", new Pergunta("Qual comando para gerar números aleatórios?", "Console.Random", "Math.Random", "Random", "Random.Round"));
        getPergunta();    
    }
